          ...
          <div class="nav-wrapper">
            <div class="row">
              <div class="col s12 m10 offset-m1 ">
                <h1 class="header" Style="font-size:25px"><i class="far fa-check-circle"></i> Configure Holiday</h1>
              </div>
            </div>
          </div>
        </div>
...
function addButtonPanel(tbl) {
    ...
    function myFunction() {        
        ...
        $.ajax({
          type: "POST",
          url: "slot_holiday.php", 
          data: input,                     
          success: function(response){
              console.log(response);
            $(".slot").html("<div class='alert alert-success' role='alert'>Successfully updated.</div>");           
          }
    ...
    {
        $(".slot").html("<div class='alert alert-danger' role='alert'>Please Select The Dates.</div>");
    }
    }
